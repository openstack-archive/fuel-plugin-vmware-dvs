...
Unfortunately each of them has defects. Nova-network is obsolete network
...
After the VMware DVS plugin is installed there is new checkbox "Neutron with
VMware DVS" on the "Networking Setup" step of wizard. UI elements of the plugin
are stored on subtab "Other" of tab "Networks" on the Fuel WebUI.
