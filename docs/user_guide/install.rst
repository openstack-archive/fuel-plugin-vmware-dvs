...
#. Copy the plugin ``.rpm`` package to the Fuel Master node:
   ...
   .. code-block:: console
     ...
     $ scp fuel-plugin-vmware-dvs-3.1-3.1.1-1.noarch.rpm <Fuel Master node ip>:/tmp
...
#. Install the plugin:
   ...
   .. code-block:: console
     ...
     # fuel plugins --install /tmp/fuel-plugin-vmware-dvs-3.1-3.1.1-1.noarch.rpm
...
#. Verify that the plugin was installed successfully:
   ...
   .. code-block:: console
     ...
     +------+--------------------------+-----------+--------------------+
     | 2    | fuel-plugin-vmware-dvs   | 3.1.1     | 4.0.0              |
     +------+--------------------------+-----------+--------------------+
