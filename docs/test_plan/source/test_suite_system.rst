...
#####
    ...
    6. In tenant "test_1"  launch VM_1 of vcenter availability zone in net1 with ip 10.0.0.4 and "SG_1" as security group.
    7. In tenant "test_1"  launch  VM_2 of nova availability zone in net1 with ip 10.0.0.5 and "SG_1" as security group.
    8. In tenant "test_2" create net2 and subnet2 with CIDR 10.0.0.0/24.
    9. In tenant "test_2" create security group "SG_2" and add rule that allows ingress icmp traffic.
    10. In tenant "test_2" launch VM_3 of nova availability zone in net2 with ip 10.0.0.4 and "SG_2" as security group.
    11. In tenant "test_2" launch VM_4 of vcenter availability zone in net2 with ip 10.0.0.5 and "SG_2" as security group.
    12. Create Router 'router_01' in tenant 'test_1'
    13. In tenant 'test_1' Attach interface of net1, subnet1 to router_1
    14. Create Router 'router_2' in tenant 'test_2'
    15. In tenant 'test_2' Attach interface of net2, subnet2 to router_2
    16. Assign floating ips for each instance
    17. Check instances in tenant_1 communicate between each other by internal ip
    18. Check instances in tenant_2 comunicate between each other by internal ip
...
#####
    ...
    8. Add 1 nodes with compute-vmware role,configure Nova Compute instance on compute-vmware and redeploy cluster.
