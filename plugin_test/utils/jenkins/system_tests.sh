...
revert_ws() {
  ...
  do
    ...
    vmrun -T ws-shared -h https://localhost:443/sdk -u $WS_USERNAME -p $WS_PASSSWORD revertToSnapshot "[standard] $i/$i.vmx" $WS_SNAPSHOT || { echo "Error: revert of $i falied";  return 1; }
