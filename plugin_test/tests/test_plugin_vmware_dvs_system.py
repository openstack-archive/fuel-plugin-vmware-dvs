...
class TestDVSSystem(TestBasic):
    ...
    def dvs_vcenter_ping_public(self):
        ...
        fip = openstack.create_and_assign_floating_ip(os_conn, instances)
    ...
    def dvs_instances_one_group(self):
        ...
        fip = openstack.create_and_assign_floating_ip(os_conn, srv_list)
    ...
    def dvs_vcenter_security(self):
        ...
        floating_ip = openstack.create_and_assign_floating_ip(
            os_conn, srv_list)
    ...
    def dvs_vcenter_tenants_isolation(self):
        ...
        self.show_step(7)
        fip_1 = openstack.create_and_assign_floating_ip(admin, srv_1)
        ips_1 = []
        for srv in srv_1:
            ips_1.append(admin.get_nova_instance_ip(
                srv, net_name=self.inter_net_name))

        fip_2 = openstack.create_and_assign_floating_ip(test, srv_2)
        ips_2 = []
        for srv in srv_2:
    ...
    def dvs_vcenter_same_ip(self):
        ...
        fip_1 = openstack.create_and_assign_floating_ip(test, srv_1)
        ips_1 = []
        for srv in srv_1:
        ...
        self.show_step(11)
        self.show_step(12)
        fip_2 = openstack.create_and_assign_floating_ip(admin, srv_2)
        ips_2 = []
        for srv in srv_2:
