...
class TestDVSSystem(TestBasic):
    ...
    def dvs_instances_one_group(self):
        ...
        logger.info("Launching few instances in nova and vcenter "
                    "availability zone")
        os_ip = self.fuel_web.get_public_vip(cluster_id)
        os_conn = os_actions.OpenStackActions(
            os_ip, SERVTEST_USERNAME,
    ...
    def dvs_vcenter_security(self):
        ...
        Scenario:
            ...
            12. Check that ssh isn't available to instances.
    ...
    def dvs_connect_default_net(self):
        ...
        Scenario:
            ...
            4. Verify that instances on different hypervisors communicate
               between each other. Send icmp ping from VM_1 instances of
               vCenter to instances from Qemu/KVM and vice versa.
    ...
    def dvs_connect_nodefault_net(self):
        ...
        Scenario:
            ...
            5. Verify that instances on different hypervisors communicate
               between each other. Send icmp ping from VM_1 instances of
               vCenter to instances from Qemu/KVM and vice versa.
    ...
    def dvs_ping_without_fip(self):
        ...
        Scenario:
            ...
            6. Launch instances VM_3 and VM_4 in the net01 with
               image TestVM-VMDK and flavor m1.micro in vcenter az.
            7. Send ping from instances to 8.8.8.8 or other outside ip.
    ...
    def dvs_instances_batch_mix_sg(self):
        ...
        logger.info("Launch few instances in nova and vcenter "
                    "availability zone")
        os_ip = self.fuel_web.get_public_vip(cluster_id)
        os_conn = os_actions.OpenStackActions(
            os_ip, SERVTEST_USERNAME,
    ...
    def dvs_attached_ports(self):
        ...
        Scenario:
            ...
            9. Attached ports of all instances to default internal net.
               To activate new interface on cirros restart network:
