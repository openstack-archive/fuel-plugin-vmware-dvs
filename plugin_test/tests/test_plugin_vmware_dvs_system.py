...
class TestDVSSystem(TestBasic):
    ...
    def dvs_vcenter_multiple_nics(self):
        ...
        ips = {
            self.net_data[0]['name']: {'ips': [], 'access_point_ip': ''},
            self.net_data[1]['name']: {'ips': [], 'access_point_ip': ''}
        }
        ...
        self.show_step(5)
        for ip in ips[self.net_data[0]['name']]['ips']:
            access_point_ip = ips[self.net_data[0]['name']]['access_point_ip']
            command = (
