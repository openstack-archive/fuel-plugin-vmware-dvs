...
class TestDVSSystem(TestBasic):
    ...
    def dvs_attached_ports(self):
        ...
        point1, access_point_ip_1 = openstack.create_access_point(
            os_conn=os_conn,
            nics=[{'net-id': net1['id']}],
        ...
        point2, access_point_ip_2 = openstack.create_access_point(
            os_conn=os_conn,
        ...
        openstack.check_connection_through_host(remote=access_point_ip_1,
                                                ...
                                                ip_pair=ip_pairs,
                                                result_of_command=1)
        for instance in instances_1 + instances_2:
            os_conn.nova.servers.delete(instance)
	for instance in (point1, point2):
            os_conn.nova.servers.delete(instance)
